...
2.  **Time Series Forecasting**
    ...
    -   Time Series Decomposition: visualize trend, seasonal and residuals from the dataset.

    -   Forecasting:

        -   Parameters configuration: Identify and fine tune different models' parameters

        -   Benchmarking: Compare among different models using MAE, RMSE and MAPE.
